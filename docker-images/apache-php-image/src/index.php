...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Poubelle - une poubelle qui vous met en valeur</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-inline-flex" href="index.html"><span class="text-light fs-2 fw-bold ms-2">Poubelle</span></a>
          <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item px-2"><a class="nav-link fw-bold" aria-current="page" href="#poubelle">Poubelle</a></li>
              <li class="nav-item px-2"><a class="nav-link fw-bold" href="#dynamique">Dynamique</a></li>
            </ul>
            <form class="d-flex"><a class="text-primary" href="#!">
              ...
              <div class="ms-4 text-light fw-bold"> 024 421 12 12 </div>
            </form>
          </div>
        </div>
      </nav>
      <section class="py-0" id="header">
        ...
        <div class="container" id="poubelle">
          <div class="row align-items-center min-vh-75 min-vh-xl-100">
            <div class="col-md-8 col-lg-6 text-md-start text-center">
              <h1 class="display-1 lh-sm text-uppercase text-light">Une poubelle qui vous met en <br class="d-none d-xxl-block" /> VALEUR </h1>
      ...
      <section id="testimonial">
        ...
        <div class="container" id="dynamique">
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-6 col-sm-4 col-xl-3 mb-3">
              ...
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="text-800 text-decoration-none text-uppercase fw-bold" href="https://www.landi.ch/fr/shop/poubelles_150504/conteneur-a-ordures-800-l_75930">Poubelle en métal</a></li>
                <li class="lh-lg"><a class="text-800 text-decoration-none text-uppercase fw-bold" href="https://www.landi.ch/fr/shop/poubelles_150504/poubelle-verte-770-l_10427">Poubelle en plastique</a></li>
                <li class="lh-lg"><a class="text-800 text-decoration-none text-uppercase fw-bold" href="https://www.landi.ch/fr/shop/accessoires-pour-chiens_130104/sachet-p-excrements-bitsdog-50-pcs_26451">Sachet bitsdog(bestseller)</a></li>
                <li class="lh-lg"><a class="text-800 text-decoration-none text-uppercase fw-bold" href="https://www.comment-economiser.fr/poubelle-sente-bon.html">Astuce pour votre poubelle</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-4 col-xl-3 mb-3">
              <h5 class="mb-5"></h5>
    ...
    <audio autoplay id="oof">
      <source src="./assets/music/rick-astley-never-gonna-give-you-up-video.mp3">
    </audio>
  </body>
